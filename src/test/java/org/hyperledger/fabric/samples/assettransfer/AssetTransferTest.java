    ...
    class DuplicateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            when(stub.getStringState("asset1"))
                    .thenReturn("{ \"assetID\": \"asset1\", \"color\": \"blue\", \"size\": 5, \"owner\": \"Tomoko\", \"appraisedValue\": 300 }");
            */
            Asset newAsset = contract.DuplicateAsset(ctx, "asset1", "Dr Evil");
            assertThat(newAsset.getAppraisedValue()).isEqualTo(300);
            assertThat(newAsset.getColor()).isEqualTo("blue");
            assertThat(newAsset.getSize()).isEqualTo(5);
            assertThat(newAsset.getOwner()).isEqualTo("Dr Evil");
            assertThat(newAsset.getAssetID()).isNotEqualTo("asset1");
        }
